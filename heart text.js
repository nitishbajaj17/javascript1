...
function abrir_redes(id_div_contenido,id_div_compartir,id_div_message)
...
function cerrar_compartir(id_div_contenido,id_div_compartir,id_div_message){document.getElementById(id_div_message).innerHTML = "";}				   
var str1="",str2="";
...
var globIdmessage = "message1",globIdTexto = "x";
    
    function exito(idTexto) { console.log("ENTRA exientraaaa"); MostrarAlerta(2500,"Text copied!","#01A9DB",idTexto); }
    function fracaso(idTexto) { MostrarAlerta(5500,"Could not copy, please do manual copy or try another browser ...","#F79F81",idTexto); }
    function excepcion(idTexto) {MostrarAlerta(5500,"Could not copy, please do manual copy or try another browser ...","#F79F81",idTexto); }
    ...
    function MostrarAlerta(tiempo,texto1,color,idTexto) { elemento1 = document.createElement("div"); id5=idTexto+"_msg"; inputExist=document.getElementById(id5);
                                              if(!inputExist){elemento1.id = id5; elemento1.innerHTML="<div style='color:#fff; background:"+color+"; position: absolute; right: 5px; margin:-75px 0;padding: 2px; background: tomato; '>"+texto1+"</div>";
...
var a26=descodificarEntidad("������������������������������������������������������1234567890������������������������������������������������������");
...
var a50=descodificarEntidad("ɐqɔpǝɟƃɥıɾʞlɯuuodbɹsʇnʌʍxʎz��������������������ɐqɔpǝɟƃɥıɾʞlɯuuodbɹsʇnʌʍxʎz");
